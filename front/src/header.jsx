...
<div className={visible?"visible":"invisible"} ><ul className="absolute w-2/6 right-0 left-auto  bg-gray-50 rounded-lg border border-gray-100 md:flex-row p-3 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
<li>
          <button onClick={()=>navigate('/')} className="block py-2 pr-4 pl-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">Home</button>
        </li>
        <li>
